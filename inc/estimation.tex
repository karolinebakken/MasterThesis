...
\noindent Several analyses were done to create a relation between the applied angle and the total angle. The relationship was found to be linear as can be seen in Figure \ref{fig:anglerel}, with the following expression:
