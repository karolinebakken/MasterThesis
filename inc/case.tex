...
The wave loads to be applied to the floating wind turbine are based on the scatter diagram for the location in West of Barra. According to the transfer functions obtained from Dr.Techn.Olav Olsen, severe resonance will occur at periods around 19s-24s. To avoid the area of severe resonance, the sea states for the periods 17-18 seconds and 18-19 seconds have been moved to the 16-17 seconds column as can be seen in Figures \ref{fig:scato} and \ref{fig:scatn}
...
\end{figure}
 ...
 \cite{Lifes50+D1.1} states that there are no data on the correlation between the wind direction and the wave direction \todo{checm out WP7}
 \subsection{Current}
