...
\caption[$\; \:$Cable hang off position]{Cable hang off position, modified from \cite{Lifes50+D4.2}}
 \label{fig:cabhang}
\end{wrapfigure}
To reproduce the motion of OO-Star, Dr. Techn. Olav Olsen have provided the transfer functions for all 6 degrees of freedom of the vessel. The transfer functions apply for the center of the model, but the cable was attached some distance from the center of gravity as can be seen in Figure \ref{fig:cabhang}. The distance between the center and the cable hang off was 9.24m, and was accounted for in the modeling process. The transfer functions of OO-Star are confidential and can not be reproduced in this report. 
...
\caption[$\; \:$Cable cross-section]{Illustration of cable cross-section}
 \label{fig:cross2}
\end{figure}
...
\end{equation}
  ...
  \newline 
  \noindent The dimensions of the cable cross-section are given in Table \ref{table:cabledim}.  
...
Sheath 3 & 42.82& 3  \\
 ...
 \hline
\end{tabular}
\caption{Dimensions of the local model}
...
\caption[$\; \:$West of Barra, Scotland]{ West of Barra, Scotland,, \cite{Lifes50+D1.1} }
 \label{fig:wob}
\end{figure}
...
\end{figure}
 ...
 \noindent The maximum annual wind speed at 10 m above sea surface with 1-year return period is calculated by \cite{Lifes50+D1.1} to be  29.36 $\frac{m}{s}$
...
\caption[$\; \:$Original wave scatter diagram]{Original wave scatter diagram,\cite{Lifes50+D1.1} }
 \label{fig:scato}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{figures/scatternew}
\caption[$\; \:$Modified wave scatter diagram ]{Modified wave scatter diagram  }
 \label{fig:scatn}
\end{figure}
...
\caption[$\; \:$S-N data for case scenario]{S-N data for case scenario, \cite{s300} }
 \label{fig:snplot}
\end{figure}
