...
\end{itemize}
The testing showed that the local model was good... \todo{MERE HER} All  The results for the testing of the local model can be seen in Figures \ref{fig:bflexax} to \ref{fig:bendstiff} in Appendix \ref{appendix:B}.

Figure \ref{fig:local1} and Figure \ref{fig:local2} show the local model and some of its components.
