...
The testing showed that there is no compression in the cable, and both the curvature and max tension are at acceptable levels. The plots showing the configurations in different weather conditions with and without current as well as the   plots of tension and curvature are placed in 
...
\noindent Figure \ref{fig:bflexmx} shows the moment about the x-axis over the length of cable......
...
\caption[$\; \:$Axial force in conductors]{Axial force in conductors over length of cable [Nm]}
 \label{fig:bflexmz}
\end{figure}
\noindent Figure \ref{fig:bflexmx} displays the moment about the z-axis over the length of cable........
...
\end{figure}
\noindent Figure \ref{fig:bflexcurve} presents the curvature over the length of cable.......
\newline
