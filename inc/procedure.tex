...
\subfloat[Neutral position \label{fig:cavS2500}]
  ...
  \caption [$\; \:$Static configuration of the global model without current]{Static configuration of the global model for different vessel displacements, without current}
\label{fig:statcon}
\end{figure}
...
\caption[$\; \:$Helical components of the local model]{Helical components of the local model}
\label{fig:local2}
\end{figure}
