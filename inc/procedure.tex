...
The material of the bend stiffener is a polymer with non-linear material properties with the sam stiffness loss as the stress-strain relationship shown with the red curve in Figure \ref{fig:matbend}. The material was chosen in agreement with guidance from Professor Svein Sævik. 

\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{figures/matbend}
\caption[$\; \:$ Stress-strain relationship for bend stiffener material]{Stress-strain relationship for bend stiffener material}
 \label{fig:matbend}
\end{figure}
\todo{referansse!! }
The initial Young's modulus was chosen to be 150 GPa, with a decay in stiffness according to the red curve in Figure \ref{fig:matbend} 
